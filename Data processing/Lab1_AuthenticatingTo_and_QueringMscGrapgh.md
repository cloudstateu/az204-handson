...
### Task 2: Enable the default client type
...
1.  Using Visual Studio Code, open the **\\Day3\\files\\Lab1\\Starter\\GraphClient** folder.
...
1.  Using a terminal, run the .NET console application project:
    ...
    > **Note**: If there are any build errors, review the **Program.cs** file in the **Day3\\files\\Lab1\\Solution\\GraphClient** folder.
